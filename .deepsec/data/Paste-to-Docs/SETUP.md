# Agent setup for `Paste-to-Docs`

This is a deepsec scanning workspace. Project `Paste-to-Docs` was just registered
(target: `..`). Setup is incomplete — `data/Paste-to-Docs/INFO.md`
...
2. **Fill in `data/Paste-to-Docs/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id Paste-to-Docs
pnpm deepsec process --project-id Paste-to-Docs
```
