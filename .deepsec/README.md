...
Currently configured project: `Paste-to-Docs` (target: `..`).
...
3. Open the parent repo in your coding agent (Claude Code, Cursor, …)
   and have it follow `data/Paste-to-Docs/SETUP.md` to fill in
   `data/Paste-to-Docs/INFO.md`.
...
`--project-id Paste-to-Docs` (or whichever id you want) explicitly.

`scan` is free (regex only). `process` is the AI stage (≈$0.30/file
on Opus by default). Run state goes to `data/Paste-to-Docs/`.
